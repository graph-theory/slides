...
\begin{frame}{Rooted trees}
  \begin{description}
    \item[Root] Choose any vertex of a tree and call it a root.
    ...
    \item[Internal vertex] -- a vertex that is not a leaf.
  \end{description}
  \vspace{0.5cm}
  \begin{center}
    \begin{tikzpicture}
...
\begin{frame}{Heights and leaves of $m$-ary rooted trees}
  ...
  \begin{proof}
    ...
    For a tree of height 0, there is only one leaf and $m^0 \geq 1$.
    Next suppose the theorem is true for trees of height $h-1$, and consider a tree of height $h$ with $l$ leaves.
