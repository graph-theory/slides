...
\begin{frame}{Isomorphic Rooted Trees}
  \begin{definition}
   Two rooted trees are said to be \emph{isomorphic} if there is an isomorphism between them considered which takes the root of one tree to the root of the other.
  \end{definition}
\end{frame}
