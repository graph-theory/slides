...
\begin{frame}{Graph definition}
	\begin{definition}
	A \emph{graph} consists of a finite set $V$ and set $E$ of 2-subsets of $V$.
	\end{definition}
	\vspace{0.25cm}
	\begin{description}
...
\begin{frame}{Defining different types of graphs}
	...
	\begin{description}
		\item[Repeated edges] are edges that start and end at the same nodes.
		\item[Directed edges] are edges where a direction is added.
		\item[Looped edges] begin and end at the same node.
	\end{description}
